...
| <a name="input_branch_white_list"></a> [branch\_white\_list](#input\_branch\_white\_list) | List of branch names that will be allowed to use the github app. Leave empty for no filtering. | `list(string)` | `[]` | no |
